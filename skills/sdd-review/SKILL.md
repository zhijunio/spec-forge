...
For detailed profiling and optimization, see **`skills/sdd-review/references/performance-checklist.md`** (same role as **`performance-optimization`** / `references/performance-checklist.md` in [code-review-and-quality](https://github.com/addyosmani/agent-skills/blob/main/skills/code-review-and-quality/SKILL.md)). Does the change introduce performance problems?
...
- For detailed security review guidance, see **`skills/sdd-review/references/security-checklist.md`**
- For performance review checks, see **`skills/sdd-review/references/performance-checklist.md`**
